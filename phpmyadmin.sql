...
('root','[{\"db\":\"eazzylogin\",\"table\":\"users\"},{\"db\":\"firstDB\",\"table\":\"users\"},{\"db\":\"lema\",\"table\":\"users\"},{\"db\":\"project02\",\"table\":\"travelas_car\"}]');
...
('root','2023-12-02 18:20:14','{\"Console\\/Mode\":\"show\",\"Console\\/Height\":212.002}');
...
-- Dump completed on 2024-01-12 21:04:18
